...
void distributed_shade_cooperative_coevolutive::minimize(optimization_problem &problem, std::vector<scalar> &x0) {
...
void distributed_shade_cooperative_coevolutive::setting_method(size_t d){
...
void distributed_shade_cooperative_coevolutive::update_best_solution(std::vector<scalar> &x, scalar fx, size_t i){
...
void distributed_shade_cooperative_coevolutive::generate_random_index(std::vector<size_t> &v, size_t n, size_t min, size_t max){
...
scalar distributed_shade_cooperative_coevolutive::get_bounds(scalar x, scalar min_bound, scalar max_bound){
    if(x > max_bound){
        return max_bound;
    }else if(x < min_bound){
        return min_bound;
...
std::string distributed_shade_cooperative_coevolutive::get_method(migration_method m){
    std::string met;
...
void distributed_shade_cooperative_coevolutive::differential_mutation_operator(
...
*/
void distributed_shade_cooperative_coevolutive::ddms_evolution(optimization_problem &problem, size_t index_sub_problem){
...
std::vector<scalar> distributed_shade_cooperative_coevolutive::get_best_solution() const{
    return this->best_solution;
}

int distributed_shade_cooperative_coevolutive::get_rank() const{
    return this->rank;
}

scalar distributed_shade_cooperative_coevolutive::rand_0_1() {
	scalar r = static_cast <scalar> (rand()) / static_cast <scalar> (RAND_MAX);
	return r;
}

void distributed_shade_cooperative_coevolutive::convergence(std::set<size_t> &sub_problem){
...
void distributed_shade_cooperative_coevolutive::stagnation(std::set<size_t> &sub_problem, size_t isub){
...
void distributed_shade_cooperative_coevolutive::need_rediversify(std::set<size_t> &sub_problem){
...
// TEDA CLOUD
void distributed_shade_cooperative_coevolutive::teda_cloud(node ind, optimization_problem &problem){
...
void distributed_shade_cooperative_coevolutive::update_cloud(size_t c, node ind){
...
scalar distributed_shade_cooperative_coevolutive::distance(std::vector<scalar> x, std::vector<scalar> uk){
    scalar sum = 0.0;
    scalar distance = 0.0;
...
std::vector<scalar> distributed_shade_cooperative_coevolutive::ls_process(node pop_ls, std::vector<scalar> best_point, optimization_problem &problem){
...
void distributed_shade_cooperative_coevolutive::fixed_proba_evolution(optimization_problem &problem, size_t index_sub_problem){
    std::set<size_t> sub_problem = problem.get_problem_structure()[index_sub_problem];
    std::uniform_int_distribution<int> dist_dim(0, dimension-1);
    std::uniform_real_distribution<scalar> dist_cr(0.0, 1.0);
    const size_t n_solutions = 4;
